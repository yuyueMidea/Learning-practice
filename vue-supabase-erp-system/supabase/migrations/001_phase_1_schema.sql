...
as $$
  ...
  permitted_menus as (
    ...
    where exists (select 1 from current_user)
      and m.status = 'active'
  ...
  select jsonb_build_object(
    'user', coalesce((select to_jsonb(cu) from current_user cu), '{}'::jsonb),
...
values (
  ...
  1,
  (select id from public.pur_order_items poi join public.pur_orders po on po.id = poi.order_id where po.order_no = 'PO202606230001' and poi.line_no = 1),
  (select id from public.base_products where code = 'PRD-001'),
  (select id from public.base_product_units where code = 'PCS'),
...
values (
  ...
  1,
  (select id from public.sal_order_items soi join public.sal_orders so on so.id = soi.order_id where so.order_no = 'SO202606230001' and soi.line_no = 1),
  (select id from public.base_products where code = 'PRD-001'),
  (select id from public.base_product_units where code = 'PCS'),
  (select id from public.base_warehouse_locations where code = 'A-01-01' and warehouse_id = (select id from public.base_warehouses where code = 'WH-MAIN')),
...
values (
  ...
  1,
  (select id from public.pur_receipt_items pri join public.pur_receipts pr on pr.id = pri.receipt_id where pr.receipt_no = 'PR202606230001' and pri.line_no = 1),
  (select id from public.base_products where code = 'PRD-001'),
  (select id from public.base_product_units where code = 'PCS'),
  (select id from public.base_warehouse_locations where code = 'A-01-01' and warehouse_id = (select id from public.base_warehouses where code = 'WH-MAIN')),
...
values (
  ...
  1,
  (select id from public.sal_delivery_items sdi join public.sal_deliveries sd on sd.id = sdi.delivery_id where sd.delivery_no = 'SD202606230001' and sdi.line_no = 1),
  (select id from public.base_products where code = 'PRD-001'),
  (select id from public.base_product_units where code = 'PCS'),
